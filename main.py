...
def printlogo():
    ...
    pc.printout("\nVersion 1.1 - Developed by Giuseppe Criscione but modded by Riccardo Zappitelli\n\n", pc.YELLOW)
...
def cmdlist():
    ...
    print("Download highlights of the user")
...
while True:
    ...
    if _cmd:
        ...
        try:
            from src.justme import high
            print(f"Downloading  - {args.id} -'s highlights") 
            high(args.id)
